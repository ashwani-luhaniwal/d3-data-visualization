...
function calcColorScale(data) {
    // TODO: minor, check how many data points we've got with few datapoints the
    // resulting legend gets confusing
...
function legendMouseOver(color_key, color, data) {
    // cancels ongoing transactions (eg for quick mouseovers)
...
// sorts an array of equally structured objects by a key only works if sortkey contains unique
// values
// TODO: minor, shorten
