const Coco = {}
// function load_coco_chart(coco) {

const labels = ["pm10", "pm25", "no2", "o3"]
const color = ['steelblue', 'red', 'green', 'orange']
...
const url = 'http://cocopuff.va11y.com/station/data/', stationId = '5a5b9886c9310903066bfaa4';

//exports    
Coco.coco_chart = get_chart_setting

//functions
function get_chart_setting(element) {
